...
# Changelog
**Version 1.5**
Updated to GPT 4 Omni Mini, and added a couple of features such as a fuzzy Search function within the Gallery, "Streaming" responses from the AI, as well as implementing Infinite Scroll loading for the Gallery.
